...
public class DeThiDAO {
    ...
    public List<DeThiDTO> getByKyThi(int maKyThi) throws SQLException {
        ...
        String sql = "SELECT dt.*, hp.ten_mon, kt.ten_ky_thi, CONCAT(gv.ho, ' ', gv.ten) AS ten_gv " +
                ...
                "LEFT JOIN KyThi kt ON dt.ma_ky_thi = kt.ma_ky_thi " +
                "LEFT JOIN GiangVien gv ON dt.ma_gv = gv.ma_gv " +
                "WHERE dt.ma_ky_thi = ? ORDER BY dt.ten_de_thi";
    ...
    public List<DeThiDTO> getByGiangVien(int maGV) throws SQLException {
        ...
        String sql = "SELECT dt.*, hp.ten_mon, kt.ten_ky_thi, CONCAT(gv.ho, ' ', gv.ten) AS ten_gv " +
                ...
                "LEFT JOIN KyThi kt ON dt.ma_ky_thi = kt.ma_ky_thi " +
                "LEFT JOIN GiangVien gv ON dt.ma_gv = gv.ma_gv " +
                "WHERE dt.ma_gv = ? ORDER BY dt.ngay_tao DESC";
    ...
    private DeThiDTO mapResultSetToDTO(ResultSet rs) throws SQLException {
        ...
        dt.setTenHocPhan(rs.getString("ten_mon"));
        dt.setTenKyThi(rs.getString("ten_ky_thi"));
        dt.setTenGV(rs.getString("ten_gv"));
        return dt;
    }
}
