...
public class QuanLySinhVienPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        // Bảng
        String[] columns = {"Mã SV", "Họ", "Tên", "Tên đăng nhập", "Email", "Ngành", "Trạng thái"};
    ...
    private void hienThiThongTin() {
        ...
        if (row >= 0) {
            ...
            txtEmail.setText((String) modelSinhVien.getValueAt(row, 4));
            
            String tenNganh = (String) modelSinhVien.getValueAt(row, 5);
